(function () {
    ...
    module.controller('AppController', function ($scope, $projekty, $filter) {
        ...
        $scope.langen = {
            ...
            create_account_text_step1: 'STEP 1 of 5',
            create_account_text_login_data: 'LOGIN DATA',
            create_account_text_step2: 'SEP 2 OF 5',
            ...
            create_account_text_step3: 'STEP 3 of 5',
            ...
            dog_text: 'dog',
            create_account_text_chip: 'chip',
            create_account_text_step4: 'STEP 4 of 5',
            ...
            create_account_text_step5: 'STEP 5 of 5',
        ...
        $scope.langde = {
            ...
            create_account_text_step1: 'Schritt 1 von 5',
            create_account_text_login_data: 'Login-Daten',
            create_account_text_step2: 'Schritt 2 von 5',
            ...
            create_account_text_step3: 'Schritt 3 von 5',
            ...
            dog_text: 'hund',
            create_account_text_chip: 'chip',
            create_account_text_step4: 'Schritt 4 von 5',
            ...
            create_account_text_step5: 'Schritt 5 von 5',
                ...
                $.ajax({
                    ...
                    success: function (respond) {
                        ...
                        if (respond.status == "success") {
                            ...
                            tmp = $scope.user.dog.distemper_vaccination_at;
                            tmp = tmp.substring(0, tmp.length - 14);
                            $scope.user.dog.distemper_vaccination_at = tmp;
                            
                            tmp = $scope.user.dog.rabies_vaccination_at;
                            tmp = tmp.substring(0, tmp.length - 14);
                            $scope.user.dog.rabies_vaccination_at = tmp;
        ...
        $scope.registerUserE3 = function () {
           if ($scope.isValidDate($scope.tmpUser.dog_birth_date)) {
                $scope.tmpUser.dog_birth_date = $scope.tmpUser.dog_birth_date + 'T12:00:00+0200';
        ...
        $scope.registerUserE4 = function () {
            if (($scope.isValidDate($scope.tmpUser.dog_rabies_vaccination_at) || $scope.tmpUser.dog_rabies_vaccination == 0) && ($scope.isValidDate($scope.tmpUser.dog_distemper_vaccination_at) || $scope.tmpUser.dog_distemper_vaccination == 0)) {
                $scope.tmpUser.dog_distemper_vaccination_at=$scope.tmpUser.dog_distemper_vaccination_at + 'T12:00:00+0200';
                $scope.tmpUser.dog_rabies_vaccination_at=$scope.tmpUser.dog_rabies_vaccination_at + 'T12:00:00+0200';
        ...
        $scope.backToCurseDetails = function (id) {
        ...
        $scope.saveSettings = function () {
            ...
            if (($scope.isValidDate($scope.user.dog.rabies_vaccination_at) || $scope.user.dog.rabies_vaccination == 0) && ($scope.isValidDate($scope.user.dog.distemper_vaccination_at) || $scope.user.dog.distemper_vaccination == 0)) {
                sendData = true;
            ...
            if ($scope.user.new_avatar) {
                ...
                var dataToSend = {
                    ...
                    dog_rabies_vaccination_at: $scope.user.dog.rabies_vaccination_at + 'T12:00:00+0200',
                    dog_distemper_vaccination: $scope.user.dog.distemper_vaccination,
                    dog_distemper_vaccination_at: $scope.user.dog.distemper_vaccination_at + 'T12:00:00+0200',
